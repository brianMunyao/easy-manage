    ...
    <div class="form-container">
        <form action="" method="post">
            <div class="form">
                ...
                <?php echo do_shortcode('[input_con name="email" label="Email Address" error="' . $email_error . '" placeholder="Enter their email address" input_type="email" value="' . $user_info->email . '"]') ?>
